...
preguntas_geografía={"¿Cuál es la montaña más alta de España? (Escríbelo sin artículos)": "Teide",
                    "¿El mar muerto es realmente un mar? (Escribe 'sí' o 'no')":"No",
                    "¿Qué continente es el más poblado?":"Asia",
                    "¿Qué río pasa por más países? (Escríbelo sin artículos)":"Danubio",
                    "¿Cuál es el país más pequeño del mundo? (Escríbelo sin artículos)":"Ciudad del Vaticano",
                    "¿Cuántos océanos hay en la Tierra? (Inserta un número)" : "5",
                    "¿Qué río pasa por París? (Escríbelo sin artículos)" : "Sena",
                    "¿Cuál es el río más largo de España? (Escríbelo sin artículos)" : "Tajo",
                    "¿Qué ocupa más superficie, el agua o los continentes? (Escribe 'agua' o 'continentes')" : "agua",
                    "¿Cuál es el continente más seco del planeta? (Escribe sin acentos ni artículos)": "Antartida",
